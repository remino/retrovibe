...
// Grayscale version of yeetron.
// Original: https://github.com/joncampbell123/dosbox-x/blob/3077039cdf7b4dab4e33a4765d06dcdec55d4501/contrib/glshaders/yeetron.glsl
...
void main()
{
	...
	r1.z = c5.z;
	r0.w = r1.z + -c2.y;
	vec3 finalColor = (r0.w >= 0.0 ? r3 : r0).xyz;
	float grey = dot(finalColor.rgb, vec3(0.299, 0.587, 0.114));
	FragColor = vec4(grey, grey, grey, FragColor.w);
}
#endif
